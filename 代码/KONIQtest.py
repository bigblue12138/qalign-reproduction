...
# 1000张图片存放文件夹
IMG_DIR = "/home/s202510010/workspace/test/Q-Align-main/fuxian/koniq/sampletest"
# 数据文件 (含图片名和纯 MOS)
EXCEL_PATH = "/home/s202510010/workspace/test/Q-Align-main/fuxian/koniq/koniqtest.xlsx"
# 模型路径
